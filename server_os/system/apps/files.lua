...
for address in component.list("filesystem") do
    ...
    table.insert(drives, {fs = fs, label = label})
    table.insert(names, label .. "  " .. common.formatBytes(fs.spaceUsed()) .. "/" .. common.formatBytes(fs.spaceTotal()))
end

local driveIndex = common.menu("Files", "Storage devices", names)
